...
filename = '/Users/mlx/Downloads/Document/talking_data/train_sample.csv'
...
train_frame['hour'], train_frame['minute'], train_frame['second'] = parse_date_custom(
    list(train_frame['click_time'].values))
